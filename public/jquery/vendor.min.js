...
(function() {
    ...
    var e, i, n, s, o, r, a, l, h, c, u, d, p, f, g, m, v, _, b, y, w, x, C, k, T, D, S, A, E, I, P, M, O, N, L, H, W, R, z, j, F, q, Y, B, X, $, U = [].slice,
        K = {}.hasOwnProperty,
        V = function(t, e) {
    ...
    for (_ = {
        ...
        }, A = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame, v = window.cancelAnimationFrame || window.mozCancelAnimationFrame, d = function(t, e, i) {
        ...
        }, $ = Q, r = window.Pace || {}, window.Pace = r, b(r, $.prototype), S = r.options = b({}, _, window.paceOptions, w()), j = 0, q = (B = ["ajax", "document", "eventLag", "elements"]).length; j < q; j++) !0 === S[N = B[j]] && (S[N] = _[N]);
    ...
    function et() {
        ...
        if (null != W && S.ajax.trackWebSockets) {
            window.WebSocket = function(t, i) {
                ...
                return O("socket") && e.trigger("request", {
                    type: "socket",
                    url: t,
                    protocols: i,
                    request: n
    ...
    V(J, $ = Error), o = J, Z.prototype.getElement = function() {
        var t;
        if (null == this.el) {
        ...
        return !1
    }, V(et, s), a = et, F = null, M = function(t) {
        ...
        var i, n = t.type,
            s = t.request,
            o = t.url;
        if (!M(o)) return r.running || !1 === S.restartOnRequestAfter && "force" !== O(n) ? void 0 : (i = arguments, "boolean" == typeof(o = S.restartOnRequestAfter || 0) && (o = 0), setTimeout((function() {
        ...
        this.progress = 0, s = [], n = 0, i = D(), e = setInterval((function() {
            var r = D() - i - 50;
            return i = D(), s.push(r), s.length > S.eventLag.sampleCount && s.shift(), t = f(s), ++n >= S.eventLag.minSamples && t < S.eventLag.lagThreshold ? (o.progress = 100, clearInterval(e)) : o.progress = 3 / (t + 3) * 100
        }), 50)
    }, rt.prototype.tick = function(t, e) {
        return 100 <= (e = null == e ? E(this.source, "progress") : e) && (this.done = !0), e === this.last ? this.sinceLastUpdate += t : (this.sinceLastUpdate && (this.rate = (e - this.last) / this.sinceLastUpdate), this.catchup = (e - this.progress) / S.catchupTime, this.sinceLastUpdate = 0, this.last = e), e > this.progress && (this.progress += this.catchup * t), e = 1 - Math.pow(this.progress / 100, S.easeFactor), this.progress += e * this.rate * t, this.progress = Math.min(this.lastProgress + S.maxProgressPerFrame, this.progress), this.progress = Math.max(0, this.progress), this.progress = Math.min(100, this.progress), this.lastProgress = this.progress, this.progress
    }, h = rt, m = p = H = g = P = L = null, r.running = !1, C = function() {
        ...
        for (n = 0, o = (u = null != (c = S.extraSources) ? c : []).length; n < o; n++) N = u[n], L.push(new N(S));
        ...
        return r.running = !0, g.render(), t = D(), m = !1, p = I((function(e, i) {
            ...
            }), Math.max(S.ghostTime, Math.max(S.minTime - (D() - t), 0)))) : i()
        }))
    }, r.start = function(t) {
        b(S, t), r.running = !0;
        try {
        ...
        return r
    })) : "object" == typeof exports ? module.exports = r : S.startOnPageLoad && r.start()
}).call(this),
    function(t, e) {
        "use strict";
        ...
        var C = function(t) {
            ...
            try {
                O.apply(I = N.call(w.childNodes), w.childNodes), I[w.childNodes.length].nodeType
            } catch (e) {
                O = {
            ...
            function at(t, e, n, s) {
                ...
                if (!s && (d(e), e = e || p, g)) {
                    if (11 !== w && (u = Z.exec(t)))
                        ...
                        if (v = t, _ = e, 1 === w && (X.test(t) || B.test(t))) {
            ...
            for (e in i = at.support = {}, o = at.isXML = function(t) {
                    ...
                    filter: {
                        ...
                        CLASS: function(t) {
                            var e = k[t + " "];
                            return e || (e = new RegExp("(^|" + W + ")" + t + "(" + W + "|$)")) && k(t, (function(t) {
            ...
            function Ct(t, e, i, n, s, o) {
                return n && !n[y] && (n = Ct(n)), s && !s[y] && (s = Ct(s, o)), ht((function(o, r, a, l) {
                    var h, c, u, d = [],
                        p = [],
                        f = r.length,
                        g = o || function(t, e, i) {
                ...
                for (var e, i, s, o = t.length, r = n.relative[t[0].type], a = r || n.relative[" "], l = r ? 1 : 0, c = yt((function(t) {
                    ...
                    if (i = n.relative[t[l].type]) d = [yt(wt(d), i)];
                        ...
                        if ((i = n.filter[t[l].type].apply(null, t[l].matches))[y]) {
                            ...
                            return Ct(1 < l && wt(d), 1 < l && bt(t.slice(0, l - 1).concat({
                                value: " " === t[l - 2].type ? "*" : ""
                            })).replace(q, "$1"), i, l < s && kt(t.slice(l, s)), s < o && kt(t = t.slice(s)), s < o && bt(t))
                        }
                        d.push(i)
                    } return wt(d)
            }
            return _t.prototype = n.filters = n.pseudos, n.setFilters = new _t, r = at.tokenize = function(t, e) {
                ...
                for (a = t, l = [], h = n.preFilter; a;) {
                    for (r in i && !(s = Y.exec(a)) || (s && (a = a.slice(s[0].length) || a), l.push(o = [])), i = !1, (s = B.exec(a)) && (i = s.shift(), o.push({
                            value: i,
                            type: s[0].replace(q, " ")
                ...
                var i, s, o, a, l, c, u = [],
                    ...
                    m = D[t + " "];
                if (!m) {
                    for (e || (e = r(t)), i = e.length; i--;)(m = kt(e[i]))[y] ? u.push(m) : f.push(m);
                    (m = D(t, (s = f, a = 0 < (o = u).length, l = 0 < s.length, c = function(t, e, i, r, c) {
                        var u, f, m, v = 0,
                            ...
                            T = C.length;
                        for (c && (h = e == p || e || c); _ !== T && null != (u = C[_]); _++) {
                            if (l && u) {
                        ...
                        if (v += _, a && _ !== v) {
                            ...
                            O.apply(r, y), c && !t && 0 < y.length && 1 < v + o.length && at.uniqueSort(r)
                        }
                        return c && (x = k, h = w), b
                    }, a ? ht(c) : c))).selector = t
                }
            ...
            }, i.sortStable = y.split("").sort(A).join("") === y, i.detectDuplicates = !!u, d(), i.sortDetached = ct((function(t) {
        ...
        w.filter = function(t, e, i) {
            ...
            is: function(t) {
                return !!E(this, "string" == typeof t && D.test(t) ? w(t) : t || [], !1).length
            }
        });
        var I, P = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
        (w.fn.init = function(t, e, i) {
            ...
            if (i = i || I, "string" == typeof t) {
                ...
                if (n[1]) {
                    if (e = e instanceof w ? e[0] : e, w.merge(this, w.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : m, !0)), A.test(n[1]) && w.isPlainObject(e))
        ...
        w.fn.extend({
            ...
            contents: function(t) {
                return null != t.contentDocument && n(t.contentDocument) ? t.contentDocument : (S(t, "template") && (t = t.content || t), w.merge([], t.childNodes))
            }
        }, (function(t, e) {
            w.fn[t] = function(i, n) {
        ...
        K.uid = 1, K.prototype = {
            ...
            remove: function(t, e) {
                ...
                if (void 0 !== n) {
                    if (void 0 !== e) {
                        i = (e = Array.isArray(e) ? e.map($) : (e = $(e)) in n ? [e] : e.match(L) || []).length;
                        for (; i--;) delete n[e[i]]
            ...
            data: function(t, e) {
                ...
                if (void 0 === t) {
                    if (this.length && (s = G.get(o), 1 === o.nodeType && !V.get(o, "hasDataAttrs"))) {
                        for (i = r.length; i--;) r[i] && 0 === (n = r[i].name).indexOf("data-") && (n = $(n.slice(5)), Z(o, n, s[n]));
        ...
        function mt(t, e) {
            var i;
            return i = void 0 !== t.getElementsByTagName ? t.getElementsByTagName(e || "*") : void 0 !== t.querySelectorAll ? t.querySelectorAll(e || "*") : [], void 0 === e || e && S(t, e) ? w.merge([t], i) : i
        }
        ...
        function kt(t, e, i, n, s, o) {
            var r, a;
            if ("object" == typeof e) {
                for (a in "string" != typeof i && (n = n || i, i = void 0), e) kt(t, a, i, n, e[a], o);
                return t
            }
        ...
        w.event = {
            ...
            special: {
                ...
                click: {
                    ...
                    _default: function(t) {
                        var e = t.target;
                        return dt.test(e.type) && e.click && S(e, "input") && V.get(e, "click") || S(e, "a")
                    }
                },
                beforeunload: {
        ...
        function Ot(t, e, i, n) {
            ...
            if (d && (r = (s = bt(e, t[0].ownerDocument, !1, t, n)).firstChild, 1 === s.childNodes.length && (s = r), r || n)) {
                ...
                if (l)
                    ...
                    }, c) : _(h.textContent.replace(At, ""), h, c))
            }
            return t
        }
        ...
        w.extend({
            ...
            clone: function(t, e, i) {
                ...
                if (e)
                    if (i)
                        for (o = o || mt(t), r = r || mt(c), n = 0, s = o.length; n < s; n++) Mt(o[n], r[n]);
                    else Mt(t, c);
        ...
        function Bt(t) {
            return w.cssProps[t] || Yt[t] || (t in qt ? t : Yt[t] = function(t) {
        ...
        function Qt(t, e, i) {
            ...
            return (!p.boxSizingReliable() && s || !p.reliableTrDimensions() && S(t, "tr") || "auto" === r || !parseFloat(r) && "inline" === w.css(t, "display", !1, n)) && t.getClientRects().length && (s = "border-box" === w.css(t, "boxSizing", !1, n), (o = a in t) && (r = t[a])), (r = parseFloat(r) || 0) + Gt(t, e, i || (s ? "border" : "content"), o, n, r) + "px"
        }
        ...
        w.extend({
            ...
            style: function(t, e, i, n) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    var s, o, r, a = $(e),
                        l = $t.test(e),
                        h = t.style;
                    if (l || (e = Bt(a)), r = w.cssHooks[e] || w.cssHooks[a], void 0 === i) return r && "get" in r && void 0 !== (s = r.get(t, !1, n)) ? s : h[e];
            ...
            css: function(t, e, i, n) {
                var s, o, r, a = $(e);
                return $t.test(e) || (e = Bt(a)), (r = w.cssHooks[e] || w.cssHooks[a]) && "get" in r && (s = r.get(t, !0, i)), void 0 === s && (s = zt(t, e, n)), "normal" === s && e in Kt && (s = Kt[e]), "" === i || i ? (o = parseFloat(s), !0 === i || isFinite(o) ? o || 0 : s) : s
            }
        }), w.each(["height", "width"], (function(t, e) {
            w.cssHooks[e] = {
                get: function(t, i, n) {
                    if (i) return !Xt.test(w.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? Qt(t, e, n) : Wt(t, Ut, (function() {
                        return Qt(t, e, n)
                    }))
                },
                set: function(t, i, n) {
            ...
            _default: {
                ...
                set: function(t) {
                    w.fx.step[t.prop] ? w.fx.step[t.prop](t) : 1 !== t.elem.nodeType || !w.cssHooks[t.prop] && null == t.elem.style[Bt(t.prop)] ? t.elem[t.prop] = t.now : w.style(t.elem, t.prop, t.now + t.unit)
                }
            }
        ...
        function he(t, e, i) {
            ...
            for (function(t, e) {
                    var i, n, s, o, r;
                    for (i in t)
                        if (s = e[n = $(i)], o = t[i], Array.isArray(o) && (s = o[1], o = t[i] = o[0]), i !== n && (t[n] = o, delete t[i]), (r = w.cssHooks[n]) && "expand" in r)
        ...
        w.extend(w.event, {
            trigger: function(e, i, n, s) {
                ...
                if (r = p = a = n = n || m, 3 !== n.nodeType && 8 !== n.nodeType && !_e.test(_ + w.event.triggered) && (-1 < _.indexOf(".") && (_ = (b = _.split(".")).shift(), b.sort()), h = _.indexOf(":") < 0 && "on" + _, (e = e[w.expando] ? e : new w.Event(_, "object" == typeof e && e)).isTrigger = s ? 2 : 3, e.namespace = b.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : w.makeArray(i, [e]), d = w.event.special[_] || {}, s || !d.trigger || !1 !== d.trigger.apply(n, i))) {
                    ...
                    for (o = 0;
                        (r = v[o++]) && !e.isPropagationStopped();) p = r, e.type = 1 < o ? l : d.bindType || _, (u = (V.get(r, "events") || Object.create(null))[e.type] && V.get(r, "handle")) && u.apply(r, i), (u = h && r[h]) && u.apply && U(r) && (e.result = u.apply(r, i), !1 === e.result && e.preventDefault());
                    return e.type = _, s || e.isDefaultPrevented() || d._default && !1 !== d._default.apply(v.pop(), i) || !U(n) || h && f(n[_]) && !g(n) && ((a = n[h]) && (n[h] = null), w.event.triggered = _, e.isPropagationStopped() && p.addEventListener(_, be), n[_](), e.isPropagationStopped() && p.removeEventListener(_, be), w.event.triggered = void 0, a && (n[h] = a)), e.result
                }
            },
        ...
        function Se(t, e, i, n) {
            ...
            if (Array.isArray(e)) w.each(e, (function(e, s) {
                i || Ce.test(t) ? n(t, s) : Se(t + "[" + ("object" == typeof s && null != s ? e : "") + "]", s, i, n)
            }));
            else if (i || "object" !== b(e)) n(t, e);
            else
                for (s in e) Se(t + "[" + s + "]", e[s], i, n)
        }
        ...
        We.href = ye.href, w.extend({
            ...
            ajax: function(e, i) {
                ...
                if (v.promise(k), p.url = ((e || p.url || ye.href) + "").replace(Oe, ye.protocol + "//"), p.type = i.method || i.type || p.method || p.type, p.dataTypes = (p.dataType || "*").toLowerCase().match(L) || [""], null == p.crossDomain) {
                    l = m.createElement("a");
                    try {
                ...
                if (p.data && p.processData && "string" != typeof p.data && (p.data = w.param(p.data, p.traditional)), ze(Ne, p, i, k), h) return k;
                for (u in (c = w.event && p.global) && 0 == w.active++ && w.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Me.test(p.type), s = p.url.replace(Ee, ""), p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(Ae, "+")) : (d = p.url.slice(s.length), p.data && (p.processData || "string" == typeof p.data) && (s += (xe.test(s) ? "&" : "?") + p.data, delete p.data), !1 === p.cache && (s = s.replace(Ie, "$1"), d = (xe.test(s) ? "&" : "?") + "_=" + we.guid++ + d), p.url = s + d), p.ifModified && (w.lastModified[s] && k.setRequestHeader("If-Modified-Since", w.lastModified[s]), w.etag[s] && k.setRequestHeader("If-None-Match", w.etag[s])), (p.data && p.hasContent && !1 !== p.contentType || i.contentType) && k.setRequestHeader("Content-Type", p.contentType), k.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + He + "; q=0.01" : "") : p.accepts["*"]), p.headers) k.setRequestHeader(u, p.headers[u]);
                if (p.beforeSend && (!1 === p.beforeSend.call(f, k, p) || h)) return k.abort();
                if (C = "abort", _.add(p.complete), k.done(p.success), k.fail(p.error), n = ze(Le, p, i, k)) {
                    if (k.readyState = 1, c && g.trigger("ajaxSend", [k, p]), h) return k;
                ...
                function T(e, i, r, l) {
                    var u, d, m, y, x, C = i;
                    h || (h = !0, a && t.clearTimeout(a), n = void 0, o = l || "", k.readyState = 0 < e ? 4 : 0, u = 200 <= e && e < 300 || 304 === e, r && (y = function(t, e, i) {
                    ...
                    }(p, k, r)), !u && -1 < w.inArray("script", p.dataTypes) && w.inArray("json", p.dataTypes) < 0 && (p.converters["text script"] = function() {}), y = function(t, e, i, n) {
                        var s, o, r, a, l, h = {},
                            c = t.dataTypes.slice();
                        if (c[1])
        ...
        w.ajaxSetup({
            ...
            jsonpCallback: function() {
                var t = Be.pop() || w.expando + "_" + we.guid++;
                return this[t] = !0, t
            }
            ...
            if (a || "jsonp" === e.dataTypes[0]) return s = e.jsonpCallback = f(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Xe, "$1" + s) : !1 !== e.jsonp && (e.url += (xe.test(e.url) ? "&" : "?") + e.jsonp + "=" + s), e.converters["script json"] = function() {
                ...
                void 0 === o ? w(t).removeProp(s) : t[s] = o, e[s] && (e.jsonpCallback = i.jsonpCallback, Be.push(s)), r && f(o) && o(r[0]), r = o = void 0
            })), "script"
        })), p.createHTMLDocument = ((Ye = m.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Ye.childNodes.length), w.parseHTML = function(t, e, i) {
            return "string" != typeof t ? [] : ("boolean" == typeof e && (i = e, e = !1), e || (p.createHTMLDocument ? ((n = (e = m.implementation.createHTMLDocument("")).createElement("base")).href = m.location.href, e.head.appendChild(n)) : e = m), o = !i && [], (s = A.exec(t)) ? [e.createElement(s[1])] : (s = bt([t], e, o), o && o.length && w(o).remove(), w.merge([], s.childNodes)));
            var n, s, o
        ...
        }, w.isArray = Array.isArray, w.parseJSON = JSON.parse, w.nodeName = S, w.isFunction = f, w.isWindow = g, w.camelCase = $, w.type = b, w.now = Date.now, w.isNumeric = function(t) {
            var e = w.type(t);
    ...
    function(t) {
        ...
        t.cleanData = (e = t.cleanData, function(i) {
            ...
            _classes: function(e) {
                ...
                function s(s, o) {
                    for (var r, a = 0; a < s.length; a++) r = n.classesElementLookup[s[a]] || t(), r = e.add ? (function() {
                        var i = [];
                    ...
                    }(), t(t.uniqueSort(r.get().concat(e.element.get())))) : t(r.not(e.element).get()), n.classesElementLookup[s[a]] = r, i.push(s[a]), o && e.classes[s[a]] && i.push(e.classes[s[a]])
                }
                return (e = t.extend({
        ...
        })), t.widget, n = Math.max, s = Math.abs, o = /left|center|right/, r = /top|center|bottom/, a = /[\+\-]\d+(\.[\d]+)?%?/, l = /^\w+/, h = /%$/, c = t.fn.position, t.position = {
            scrollbarWidth: function() {
                if (void 0 !== i) return i;
                var e, n = t("<div style='display:block;position:absolute;width:200px;height:200px;overflow:hidden;'><div style='height:300px;width:auto;'></div></div>"),
                    s = n.children()[0];
            ...
            var i, h, u, d, p, v, _ = "string" == typeof(e = t.extend({}, e)).of ? t(document).find(e.of) : t(e.of),
                b = t.position.getWithinInfo(e.within),
                y = t.position.getScrollInfo(b),
                w = (e.collision || "flip").split(" "),
                x = {},
                C = 9 === (v = (C = _)[0]).nodeType ? {
                    width: C.width(),
                    height: C.height(),
                    offset: {
                        top: 0,
            ...
            return _[0].preventDefault && (e.at = "left top"), h = C.width, u = C.height, p = t.extend({}, d = C.offset), t.each(["my", "at"], (function() {
                var t, i, n = (e[this] || "").split(" ");
                (n = 1 === n.length ? o.test(n[0]) ? n.concat(["center"]) : r.test(n[0]) ? ["center"].concat(n) : ["center", "center"] : n)[0] = o.test(n[0]) ? n[0] : "center", n[1] = r.test(n[1]) ? n[1] : "center", t = a.exec(n[0]), i = a.exec(n[1]), x[this] = [t ? t[0] : 0, i ? i[0] : 0], e[this] = [l.exec(n[0])[0], l.exec(n[1])[0]]
            })), 1 === w.length && (w[1] = w[0]), "right" === e.at[0] ? p.left += h : "center" === e.at[0] && (p.left += h / 2), "bottom" === e.at[1] ? p.top += u : "center" === e.at[1] && (p.top += u / 2), i = f(x.at, h, u), p.left += i[0], p.top += i[1], this.each((function() {
                var o, r, a = t(this),
                    l = a.outerWidth(),
                    c = a.outerHeight(),
                    m = g(this, "marginLeft"),
                ...
                "right" === e.my[0] ? T.left -= l : "center" === e.my[0] && (T.left -= l / 2), "bottom" === e.my[1] ? T.top -= c : "center" === e.my[1] && (T.top -= c / 2), T.left += D[0], T.top += D[1], o = {
                    marginLeft: m,
                    marginTop: v
                }, t.each(["left", "top"], (function(n, s) {
                    t.ui.position[w[n]] && t.ui.position[w[n]][s](T, {
                        targetWidth: h,
                        targetHeight: u,
                        elemWidth: l,
                        elemHeight: c,
                    ...
                    h < l && s(i + o) < h && (f.horizontal = "center"), u < c && s(r + p) < u && (f.vertical = "middle"), n(s(i), s(o)) > n(s(r), s(p)) ? f.important = "horizontal" : f.important = "vertical", e.using.call(this, t, f)
                }), a.offset(t.extend(T, {
                    using: r
                }))
            }))
            ...
            fit: {
                left: function(t, e) {
                    ...
                    e.collisionWidth > o ? 0 < a && l <= 0 ? (i = t.left + a + e.collisionWidth - o - s, t.left += a - i) : t.left = !(0 < l && a <= 0) && l < a ? s + o - e.collisionWidth : s : 0 < a ? t.left += a : 0 < l ? t.left -= l : t.left = n(t.left - r, t.left)
                },
                top: function(t, e) {
                    var i = e.within,
                    ...
                    e.collisionHeight > o ? 0 < a && l <= 0 ? (i = t.top + a + e.collisionHeight - o - s, t.top += a - i) : t.top = !(0 < l && a <= 0) && l < a ? s + o - e.collisionHeight : s : 0 < a ? t.top += a : 0 < l ? t.top -= l : t.top = n(t.top - r, t.top)
                }
            },
            flip: {
                left: function(t, e) {
                    var i = (h = e.within).offset.left + h.scrollLeft,
                        ...
                        c = -2 * e.offset[0];
                    r < 0 ? ((i = t.left + l + h + c + e.collisionWidth - n - i) < 0 || i < s(r)) && (t.left += l + h + c) : 0 < a && (0 < (o = t.left - e.collisionPosition.marginLeft + l + h + c - o) || s(o) < a) && (t.left += l + h + c)
                },
                top: function(t, e) {
        ...
        function P(t) {
            var e = C(),
                i = e._rgba = [];
            return t = t.toLowerCase(), A(x, (function(n, s) {
                var o = (o = s.re.exec(t)) && s.parse(o);
                s = s.space || "rgba";
                if (o) return o = e[s](o), e[k[s].cache] = o[k[s].cache], i = e._rgba = o._rgba, !1
            })), i.length ? ("0,0,0,0" === i.join() && _.extend(i, $.transparent), e) : $[t]
        }

        function M(t, e, i) {
            return 6 * (i = (i + 1) % 1) < 1 ? t + (e - t) * i * 6 : 2 * i < 1 ? e : 3 * i < 2 ? t + (e - t) * (2 / 3 - i) * 6 : t
        }
        S.style.cssText = "background-color:rgba(1,1,1,.5)", D.rgba = -1 < S.style.backgroundColor.indexOf("rgba"), A(k, (function(t, e) {
            ...
            parse: function(t, e, i, n) {
                ...
                var s = this,
                    o = E(t),
                    r = this._rgba = [];
                return void 0 !== e && (t = [t, e, i, n], o = "array"), "string" === o ? this.parse(P(t) || $._default) : "array" === o ? (A(k.rgba.props, (function(e, i) {
                    r[i.idx] = I(t[i.idx], i)
                })), this) : "object" === o ? (A(k, t instanceof C ? function(e, i) {
            ...
            is: function(t) {
                var e = C(t),
                    i = !0,
                    n = this;
                return A(k, (function(t, s) {
                    var o, r = e[s.cache];
                    return r && (o = n[s.cache] || s.to && s.to(n._rgba) || [], A(s.props, (function(t, e) {
            ...
            transition: function(t, e) {
                var i = (r = C(t))._space(),
                    n = k[i],
                    s = (t = 0 === this.alpha() ? C("transparent") : this)[n.cache] || n.to(t._rgba),
                    o = s.slice(),
                    r = r[n.cache];
                return A(n.props, (function(t, i) {
                    var n = i.idx,
                        a = s[n],
                        l = r[n],
                        h = T[i.type] || {};
            ...
            toHexString: function(t) {
                var e = this._rgba.slice(),
                    i = e.pop();
                return t && e.push(~~(255 * i)), "#" + _.map(e, (function(t) {
        ...
        })).parse.prototype = C.fn, k.hsla.to = function(t) {
            ...
            C.fn[t] = function(t) {
                ...
                C.fn[e] || (C.fn[e] = function(n) {
                    var s, o = E(n),
                        ...
                        a = this[r](),
                        l = a[i.idx];
                    return "undefined" === o ? l : ("function" === o && (o = E(n = n.call(this, l))), null == n && i.empty ? this : ("string" === o && (s = w.exec(n)) && (n = l + parseFloat(s[2]) * ("+" === s[1] ? 1 : -1)), a[i.idx] = n, this[r](a)))
                })
            }))
        })), (C.hook = function(t) {
            t = t.split(" "), A(t, (function(t, e) {
                _.cssHooks[e] = {
                    set: function(t, i) {
                        var n, s, o = "";
                    ...
                    t.colorInit || (t.start = C(t.elem, e), t.end = C(t.end), t.colorInit = !0), _.cssHooks[e].set(t.elem, t.start.transition(t.end, t.pos))
                }
            }))
        })("backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor"), _.cssHooks.borderColor = {
            expand: function(t) {
                var e = {};
                return A(["Top", "Right", "Bottom", "Left"], (function(i, n) {
                    e["border" + n + "Color"] = t
                })), e
            }
        };
        var O, N, L, H, W, R, z, j, F, q, Y, B, X, $ = _.Color.names = {
                aqua: "#00ffff",
                black: "#000000",
                blue: "#0000ff",
                fuchsia: "#ff00ff",
        ...
        t.effects = {
            ...
            return this.queue((function() {
                ...
                r(), s = s.map((function() {
                    return this.end = G(this.el[0]), this.diff = function(e, i) {
                        var n, s, o = {};
            ...
            addClass: (L = t.fn.addClass, function(e, i, n, s) {
                return i ? t.effects.animateClass.call(this, {
                    add: e
                }, i, n, s) : L.apply(this, arguments)
            }),
            removeClass: (N = t.fn.removeClass, function(e, i, n, s) {
                return 1 < arguments.length ? t.effects.animateClass.call(this, {
                    remove: e
                }, i, n, s) : N.apply(this, arguments)
            }),
            toggleClass: (O = t.fn.toggleClass, function(e, i, n, s, o) {
                return "boolean" == typeof i || void 0 === i ? n ? t.effects.animateClass.call(this, i ? {
                    add: e
                } : {
                    remove: e
                }, n, s, o) : O.apply(this, arguments) : t.effects.animateClass.call(this, {
                    toggle: e
                }, i, n, s)
            }),
        ...
        }), t.expr && t.expr.pseudos && t.expr.pseudos.animated && (t.expr.pseudos.animated = (R = t.expr.pseudos.animated, function(e) {
            ...
            effect: function() {
                ...
                var i = Q.apply(this, arguments),
                    ...
                    l = i.mode,
                    h = [];
                return t.fx.off || !n ? l ? this[l](i.duration, a) : this.each((function() {
                    a && a.call(this)
                })) : !1 === o ? this.each(e).each(c) : this.queue(r, e).queue(r, c);
            ...
            e.clipInit || (e.start = t(e.elem).cssClip(), "string" == typeof e.end && (e.end = Z(e.end, e.elem)), e.clipInit = !0), t(e.elem).cssClip({
                top: e.pos * (e.end.top - e.start.top) + e.start.top,
                right: e.pos * (e.end.right - e.start.right) + e.start.right,
                bottom: e.pos * (e.end.bottom - e.start.bottom) + e.start.bottom,
                left: e.pos * (e.end.left - e.start.left) + e.start.left
            })
        }, q = {}, t.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], (function(t, e) {
            q[e] = function(e) {
        ...
        })), S = t.effects, t.effects.define("blind", "hide", (function(e, i) {
            var n = {
                    up: ["bottom", "top"],
                    vertical: ["bottom", "top"],
                    down: ["top", "bottom"],
            ...
            for (t.effects.createPlaceholder(o), l = o.css(f), h = h || o["top" == f ? "outerHeight" : "outerWidth"]() / 3, a && ((s = {
                    opacity: 1
                })[f] = l, o.css("opacity", 0).css(f, g ? 2 * -h : 2 * h).animate(s, d, p)), r && (h /= Math.pow(2, c - 1)), (s = {})[f] = l; m < c; m++)(n = {})[f] = (g ? "-=" : "+=") + h, o.animate(n, d, p).animate(s, d, p), h = r ? 2 * h : h / 2;
            r && ((n = {
                opacity: 0
            })[f] = (g ? "-=" : "+=") + h, o.animate(n, d, p)), o.queue(i), t.effects.unshift(o, e, 1 + u)
            ...
            t.effects.createPlaceholder(n), o = e.distance || n["top" == r ? "outerHeight" : "outerWidth"](!0) / 2, h[r] = a + o, s && (n.css(h), h[r] = l + o, h.opacity = 1), n.animate(h, {
                queue: !1,
                duration: e.duration,
                easing: e.easing,
                complete: i
            ...
            var n = t(this),
                ...
                f = [u[l[0]], u[l[1]]],
                g = n.queue().length;
            a && (r = parseInt(a[1], 10) / 100 * f[o ? 0 : 1]), d.clip[l[0]] = r, p.clip[l[0]] = r, p.clip[l[1]] = 0, s && (n.cssClip(p.clip), c && c.css(t.effects.clipToBox(p)), p.clip = u), n.queue((function(i) {
            ...
            }, "box" !== c && "both" !== c || (n.from.y !== n.to.y && (g = t.effects.setTransition(s, r, n.from.y, g), m = t.effects.setTransition(s, r, n.to.y, m)), n.from.x !== n.to.x && (g = t.effects.setTransition(s, a, n.from.x, g), m = t.effects.setTransition(s, a, n.to.x, m))), "content" !== c && "both" !== c || n.from.y !== n.to.y && (g = t.effects.setTransition(s, o, n.from.y, g), m = t.effects.setTransition(s, o, n.to.y, m)), u && (u = t.effects.getBaseline(u, f), g.top = (f.outerHeight - g.outerHeight) * u.y + p.top, g.left = (f.outerWidth - g.outerWidth) * u.x + p.left, m.top = (f.outerHeight - m.outerHeight) * u.y + p.top, m.left = (f.outerWidth - m.outerWidth) * u.x + p.left), delete g.outerHeight, delete g.outerWidth, s.css(g), "content" !== c && "both" !== c || (r = r.concat(["marginTop", "marginBottom"]).concat(o), a = a.concat(["marginLeft", "marginRight"]), s.find("*[width]").each((function() {
                var i = t(this),
                    s = {
        ...
        })), S = !1 !== t.uiBackCompat ? t.effects.define("transfer", (function(e, i) {
            t(this).transfer(e, i)
        })) : S, t.ui.focusable = function(e, i) {
        ...
        }, t.expr.pseudos || (t.expr.pseudos = t.expr[":"]), t.uniqueSort || (t.uniqueSort = t.unique), t.escapeSelector || (Y = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g, B = function(t, e) {
            return e ? "\0" === t ? "�" : t.slice(0, -1) + "\\" + t.charCodeAt(t.length - 1).toString(16) + " " : "\\" + t
            ...
            _animate: function(t, e, i) {
                ...
                return s = (s = "string" == typeof u ? u : s) || u.easing || c.easing, o = (o = "number" == typeof u ? u : o) || u.duration || c.duration, e.length ? t.length ? (n = t.show().outerHeight(), e.animate(this.hideProps, {
                    duration: o,
                    easing: s,
                    step: function(t, e) {
                        e.now = Math.round(t)
        ...
        var tt, et, it = /ui-corner-([a-z]){2,6}/g;
        ...
        function nt() {
            this._curInst = null, this._keyEvent = !1, this._disabledInputs = [], this._datepickerShowing = !1, this._inDialog = !1, this._mainDivId = "ui-datepicker-div", this._inlineClass = "ui-datepicker-inline", this._appendClass = "ui-datepicker-append", this._triggerClass = "ui-datepicker-trigger", this._dialogClass = "ui-datepicker-dialog", this._disableClass = "ui-datepicker-disabled", this._unselectableClass = "ui-datepicker-unselectable", this._currentClass = "ui-datepicker-current-day", this._dayOverClass = "ui-datepicker-days-cell-over", this.regional = [], this.regional[""] = {
                ...
                autoSize: !1,
                disabled: !1
            }, t.extend(this._defaults, this.regional[""]), this.regional.en = t.extend(!0, {}, this.regional[""]), this.regional["en-US"] = t.extend(!0, {}, this.regional.en), this.dpDiv = st(t("<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"))
        }
        ...
        function ot() {
            t.datepicker._isDisabledDatepicker((et.inline ? et.dpDiv.parent() : et.input)[0]) || (t(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"), t(this).addClass("ui-state-hover"), -1 !== this.className.indexOf("ui-datepicker-prev") && t(this).addClass("ui-datepicker-prev-hover"), -1 !== this.className.indexOf("ui-datepicker-next") && t(this).addClass("ui-datepicker-next-hover"))
        }
        ...
        t.widget("ui.controlgroup", {
        ...
        }), t.fn.button = (tt = t.fn.button, function(e) {
            ...
            _optionDatepicker: function(e, i, n) {
                ...
                s = i || {}, "string" == typeof i && ((s = {})[i] = n), r && (this._curInst === r && this._hideDatepicker(), o = this._getDateDatepicker(e, !0), i = this._getMinMaxDate(r, "min"), n = this._getMinMaxDate(r, "max"), rt(r.settings, s), null !== i && void 0 !== s.dateFormat && void 0 === s.minDate && (r.settings.minDate = this._formatDate(r, i)), null !== n && void 0 !== s.dateFormat && void 0 === s.maxDate && (r.settings.maxDate = this._formatDate(r, n)), "disabled" in s && (s.disabled ? this._disableDatepicker(e) : this._enableDatepicker(e)), this._attachments(t(e), r), this._autoSize(r), this._setDate(r, o), this._updateAlternate(r), this._updateDatepicker(r))
            },
            ...
            _showDatepicker: function(e) {
                var i, n, s, o;
                "input" !== (e = e.target || e).nodeName.toLowerCase() && (e = t("input", e.parentNode)[0]), t.datepicker._isDisabledDatepicker(e) || t.datepicker._lastInput === e || (o = t.datepicker._getInst(e), t.datepicker._curInst && t.datepicker._curInst !== o && (t.datepicker._curInst.dpDiv.stop(!0, !0), o && t.datepicker._datepickerShowing && t.datepicker._hideDatepicker(t.datepicker._curInst.input[0])), !1 !== (n = (s = t.datepicker._get(o, "beforeShow")) ? s.apply(e, [e, o]) : {}) && (rt(o.settings, n), o.lastVal = null, t.datepicker._lastInput = e, t.datepicker._setDateFromField(o), t.datepicker._inDialog && (e.value = ""), t.datepicker._pos || (t.datepicker._pos = t.datepicker._findPos(e), t.datepicker._pos[1] += e.offsetHeight), i = !1, t(e).parents().each((function() {
                    ...
                    return 0
                }(t(e)) + 1), t.datepicker._datepickerShowing = !0, t.effects && t.effects.effect[n] ? o.dpDiv.show(n, t.datepicker._get(o, "showOptions"), s) : o.dpDiv[n || "show"](n ? s : null), t.datepicker._shouldFocusInput(o) && o.input.trigger("focus"), t.datepicker._curInst = o)))
            },
            _updateDatepicker: function(e) {
                ...
                0 < o.length && ot.apply(o.get(0)), e.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width(""), 1 < s && e.dpDiv.addClass("ui-datepicker-multi-" + s).css("width", 17 * s + "em"), e.dpDiv[(1 !== n[0] || 1 !== n[1] ? "add" : "remove") + "Class"]("ui-datepicker-multi"), e.dpDiv[(this._get(e, "isRTL") ? "add" : "remove") + "Class"]("ui-datepicker-rtl"), e === t.datepicker._curInst && t.datepicker._datepickerShowing && t.datepicker._shouldFocusInput(e) && e.input.trigger("focus"), e.yearshtml && (i = e.yearshtml, setTimeout((function() {
            ...
            parseDate: function(e, i, n) {
                ...
                for (var s, o, r, a = 0, l = "string" != typeof(l = (n ? n.shortYearCutoff : null) || this._defaults.shortYearCutoff) ? l : (new Date).getFullYear() % 100 + parseInt(l, 10), h = (n ? n.dayNamesShort : null) || this._defaults.dayNamesShort, c = (n ? n.dayNames : null) || this._defaults.dayNames, u = (n ? n.monthNamesShort : null) || this._defaults.monthNamesShort, d = (n ? n.monthNames : null) || this._defaults.monthNames, p = -1, f = -1, g = -1, m = -1, v = !1, _ = function(t) {
            ...
            _determineDate: function(e, i, n) {
                var s, o;
                i = null == i || "" === i ? n : "string" == typeof i ? function(i) {
                    try {
            ...
            _generateHTML: function(e) {
                var i, n, s, o, r, a, l, h, c, u, d, p, f, g, m, v, _, b, y, w, x, C, k, T, D, S, A, E, I, P, M, O, N = new Date,
                    L = this._daylightSavingAdjust(new Date(N.getFullYear(), N.getMonth(), N.getDate())),
                    H = this._get(e, "isRTL"),
                    ...
                    U = e.drawYear;
                if ($ < 0 && ($ += 12, U--), X)
                    for (i = this._daylightSavingAdjust(new Date(X.getFullYear(), X.getMonth() - j[0] * j[1] + 1, X.getDate())), i = B && i < B ? B : i; this._daylightSavingAdjust(new Date(U, $, 1)) > i;) --$ < 0 && ($ = 11, U--);
                for (e.drawMonth = $, e.drawYear = U, F = this._get(e, "prevText"), F = z ? this.formatDate(F, this._daylightSavingAdjust(new Date(U, $ - N, 1)), this._getFormatConfig(e)) : F, n = this._canAdjustMonth(e, -1, U, $) ? t("<a>").attr({
                        class: "ui-datepicker-prev ui-corner-all",
                        "data-handler": "prev",
                        "data-event": "click",
                        title: F
                    }).append(t("<span>").addClass("ui-icon ui-icon-circle-triangle-" + (H ? "e" : "w")).text(F))[0].outerHTML : R ? "" : t("<a>").attr({
                        class: "ui-datepicker-prev ui-corner-all ui-state-disabled",
                        title: F
                    }).append(t("<span>").addClass("ui-icon ui-icon-circle-triangle-" + (H ? "e" : "w")).text(F))[0].outerHTML, F = this._get(e, "nextText"), F = z ? this.formatDate(F, this._daylightSavingAdjust(new Date(U, $ + N, 1)), this._getFormatConfig(e)) : F, s = this._canAdjustMonth(e, 1, U, $) ? t("<a>").attr({
                        class: "ui-datepicker-next ui-corner-all",
                        "data-handler": "next",
                        "data-event": "click",
                        title: F
                    }).append(t("<span>").addClass("ui-icon ui-icon-circle-triangle-" + (H ? "w" : "e")).text(F))[0].outerHTML : R ? "" : t("<a>").attr({
                        class: "ui-datepicker-next ui-corner-all ui-state-disabled",
                        title: F
                    }).append(t("<span>").attr("class", "ui-icon ui-icon-circle-triangle-" + (H ? "w" : "e")).text(F))[0].outerHTML, N = this._get(e, "currentText"), R = this._get(e, "gotoCurrent") && e.currentDay ? Y : L, N = z ? this.formatDate(N, R, this._getFormatConfig(e)) : N, F = "", e.inline || (F = t("<button>").attr({
                        type: "button",
                        class: "ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all",
                        "data-handler": "hide",
                        "data-event": "click"
                    }).text(this._get(e, "closeText"))[0].outerHTML), z = "", W && (z = t("<div class='ui-datepicker-buttonpane ui-widget-content'>").append(H ? F : "").append(this._isInRange(e, R) ? t("<button>").attr({
                        type: "button",
                        class: "ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all",
                        "data-handler": "today",
                        "data-event": "click"
                    }).text(N) : "").append(H ? "" : F)[0].outerHTML), o = parseInt(this._get(e, "firstDay"), 10), o = isNaN(o) ? 0 : o, r = this._get(e, "showWeek"), a = this._get(e, "dayNames"), l = this._get(e, "dayNamesMin"), h = this._get(e, "monthNames"), c = this._get(e, "monthNamesShort"), u = this._get(e, "beforeShowDay"), d = this._get(e, "showOtherMonths"), p = this._get(e, "selectOtherMonths"), f = this._getDefaultDate(e), g = "", v = 0; v < j[0]; v++) {
                    for (_ = "", this.maxRows = 4, b = 0; b < j[1]; b++) {
                        if (y = this._daylightSavingAdjust(new Date(U, $, e.selectedDay)), w = " ui-corner-all", x = "", q) {
                            if (x += "<div class='ui-datepicker-group", 1 < j[1]) switch (b) {
                                case 0:
                                    x += " ui-datepicker-group-first", w = " ui-corner-" + (H ? "right" : "left");
                                    break;
                                case j[1] - 1:
                                    x += " ui-datepicker-group-last", w = " ui-corner-" + (H ? "left" : "right");
                                    break;
                                default:
                        ...
                        for (x += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + w + "'>" + (/all|left/.test(w) && 0 === v ? H ? s : n : "") + (/all|right/.test(w) && 0 === v ? H ? n : s : "") + this._generateMonthYearHeader(e, $, U, B, X, 0 < v || 0 < b, h, c) + "</div><table class='ui-datepicker-calendar'><thead><tr>", C = r ? "<th class='ui-datepicker-week-col'>" + this._get(e, "weekHeader") + "</th>" : "", m = 0; m < 7; m++) C += "<th scope='col'" + (5 <= (m + o + 6) % 7 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + a[k = (m + o) % 7] + "'>" + l[k] + "</span></th>";
                        for (x += C + "</tr></thead><tbody>", D = this._getDaysInMonth(U, $), U === e.selectedYear && $ === e.selectedMonth && (e.selectedDay = Math.min(e.selectedDay, D)), T = (this._getFirstDayOfMonth(U, $) - o + 7) % 7, D = Math.ceil((T + D) / 7), S = q && this.maxRows > D ? this.maxRows : D, this.maxRows = S, A = this._daylightSavingAdjust(new Date(U, $, 1 - T)), E = 0; E < S; E++) {
                            for (x += "<tr>", I = r ? "<td class='ui-datepicker-week-col'>" + this._get(e, "calculateWeek")(A) + "</td>" : "", m = 0; m < 7; m++) P = u ? u.apply(e.input ? e.input[0] : null, [A]) : [!0, ""], O = (M = A.getMonth() !== $) && !p || !P[0] || B && A < B || X && X < A, I += "<td class='" + (5 <= (m + o + 6) % 7 ? " ui-datepicker-week-end" : "") + (M ? " ui-datepicker-other-month" : "") + (A.getTime() === y.getTime() && $ === e.selectedMonth && e._keyEvent || f.getTime() === A.getTime() && f.getTime() === y.getTime() ? " " + this._dayOverClass : "") + (O ? " " + this._unselectableClass + " ui-state-disabled" : "") + (M && !d ? "" : " " + P[1] + (A.getTime() === Y.getTime() ? " " + this._currentClass : "") + (A.getTime() === L.getTime() ? " ui-datepicker-today" : "")) + "'" + (M && !d || !P[2] ? "" : " title='" + P[2].replace(/'/g, "&#39;") + "'") + (O ? "" : " data-handler='selectDay' data-event='click' data-month='" + A.getMonth() + "' data-year='" + A.getFullYear() + "'") + ">" + (M && !d ? "&#xa0;" : O ? "<span class='ui-state-default'>" + A.getDate() + "</span>" : "<a class='ui-state-default" + (A.getTime() === L.getTime() ? " ui-state-highlight" : "") + (A.getTime() === Y.getTime() ? " ui-state-active" : "") + (M ? " ui-priority-secondary" : "") + "' href='#' aria-current='" + (A.getTime() === Y.getTime() ? "true" : "false") + "' data-date='" + A.getDate() + "'>" + A.getDate() + "</a>") + "</td>", A.setDate(A.getDate() + 1), A = this._daylightSavingAdjust(A);
                            x += I + "</tr>"
                        }
                        11 < ++$ && ($ = 0, U++), _ += x += "</tbody></table>" + (q ? "</div>" + (0 < j[0] && b === j[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "")
                    }
                    g += _
                }
        ...
        }, t.datepicker = new nt, t.datepicker.initialized = !1, t.datepicker.uuid = (new Date).getTime(), t.datepicker.version = "1.13.2", t.datepicker, t.ui.ie = !!/msie [\w.]+/.exec(navigator.userAgent.toLowerCase());
        var at, lt = !1;
        ...
        t(document).on("mouseup", (function() {
            ...
            _mouseDown: function(e) {
                if (!lt) {
                    ...
                    return !(n && !s && this._mouseCapture(e)) || (this.mouseDelayMet = !this.options.delay, this.mouseDelayMet || (this._mouseDelayTimer = setTimeout((function() {
                        ...
                        return i._mouseUp(t)
                    }, this.document.on("mousemove." + this.widgetName, this._mouseMoveDelegate).on("mouseup." + this.widgetName, this._mouseUpDelegate), e.preventDefault(), lt = !0))
                }
            },
            ...
            _mouseUp: function(e) {
                this.document.off("mousemove." + this.widgetName, this._mouseMoveDelegate).off("mouseup." + this.widgetName, this._mouseUpDelegate), this._mouseStarted && (this._mouseStarted = !1, e.target === this._mouseDownEvent.target && t.data(e.target, this.widgetName + ".preventClickEvent", !0), this._mouseStop(e)), this._mouseDelayTimer && (clearTimeout(this._mouseDelayTimer), delete this._mouseDelayTimer), this.ignoreMissingWhich = !1, lt = !1, e.preventDefault()
            },
            ...
            drag: function(e, i, n) {
                for (var s, o, r, a, l, h, c, u, d, p = n.options, f = p.snapTolerance, g = i.offset.left, m = g + n.helperProportions.width, v = i.offset.top, _ = v + n.helperProportions.height, b = n.snapElements.length - 1; 0 <= b; b--) h = (l = n.snapElements[b].left - n.margins.left) + n.snapElements[b].width, u = (c = n.snapElements[b].top - n.margins.top) + n.snapElements[b].height, m < l - f || h + f < g || _ < c - f || u + f < v || !t.contains(n.snapElements[b].item.ownerDocument, n.snapElements[b].item) ? (n.snapElements[b].snapping && n.options.snap.release && n.options.snap.release.call(n.element, e, t.extend(n._uiHash(), {
                    ...
                    top: 0,
                    left: h
                }).left)), d = s || o || r || a, "outer" !== p.snapMode && (s = Math.abs(c - v) <= f, o = Math.abs(u - _) <= f, r = Math.abs(l - g) <= f, a = Math.abs(h - m) <= f, s && (i.position.top = n._convertPositionTo("relative", {
                    top: c,
                    left: 0
                }).top), o && (i.position.top = n._convertPositionTo("relative", {
            ...
            start: function(e, i, n) {
                var s;
                n = n.options, n = t.makeArray(t(n.stack)).sort((function(e, i) {
                    return (parseInt(t(e).css("zIndex"), 10) || 0) - (parseInt(t(i).css("zIndex"), 10) || 0)
                }));
                n.length && (s = parseInt(t(n[0]).css("zIndex"), 10) || 0, t(n).each((function(e) {
            ...
            resize: function() {
                ...
                n.grid = l, v && (p += h), s && (f += c), g && (p -= h), m && (f -= c), /^(se|s|e)$/.test(a) ? (i.size.width = p, i.size.height = f) : /^(ne)$/.test(a) ? (i.size.width = p, i.size.height = f, i.position.top = r.top - d) : /^(sw)$/.test(a) ? (i.size.width = p, i.size.height = f, i.position.left = r.left - u) : ((f - c <= 0 || p - h <= 0) && (e = i._getPaddingPlusBorderDimensions(this)), 0 < f - c ? (i.size.height = f, i.position.top = r.top - d) : (f = c - e.height, i.size.height = f, i.position.top = r.top + o.height - f), 0 < p - h ? (i.size.width = p, i.position.left = r.left - u) : (p = h - e.width, i.size.width = p, i.position.left = r.left + o.width - p))
            }
                ...
                this.uiDialog.resizable({
                    ...
                    stop: function(n, s) {
                        ...
                        i.height = e.uiDialog.height(), i.width = e.uiDialog.width(), i.position = {
                            ...
                            at: "left" + (0 <= r ? "+" : "") + r + " top" + (0 <= a ? "+" : "") + a,
                            of: e.window
                        }, e._removeClass(t(this), "ui-dialog-resizing"), e._unblockFrames(), e._trigger("resizeStop", n, o(s))
                    }
                }).css("position", s)
            },
            ...
            _getItemsAsjQuery: function(e) {
                ...
                if (l && e)
                    for (i = l.length - 1; 0 <= i; i--)
                        for (n = (s = t(l[i], this.document[0])).length - 1; 0 <= n; n--)(o = t.data(s[n], this.widgetFullName)) && o !== this && !o.options.disabled && a.push(["function" == typeof o.options.items ? o.options.items.call(o.element) : t(o.options.items, o.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), o]);
                ...
                for (a.push(["function" == typeof this.options.items ? this.options.items.call(this.element, null, {
                    ...
                    }) : t(this.options.items, this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), this]), i = a.length - 1; 0 <= i; i--) a[i][0].each(h);
                return t(r)
            },
            ...
            _refreshItems: function(e) {
                ...
                if (d && this.ready)
                    for (i = d.length - 1; 0 <= i; i--)
                        for (n = (s = t(d[i], this.document[0])).length - 1; 0 <= n; n--)(o = t.data(s[n], this.widgetFullName)) && o !== this && !o.options.disabled && (u.push(["function" == typeof o.options.items ? o.options.items.call(o.element[0], e, {
                            item: this.currentItem
                        }) : t(o.options.items, o.element), o]), this.containers.push(o));
                for (i = u.length - 1; 0 <= i; i--)
                    for (r = u[i][1], h = (a = u[i][n = 0]).length; n < h; n++)(l = t(a[n])).data(this.widgetName + "-item", r), c.push({
                        item: l,
                        instance: r,
                        width: 0,
                        height: 0,
            ...
            _open: function(e, i, n) {
                var s, o, r, a = t.extend({}, this.options.position);
    ...
    function(t, e) {
        ...
        function M(t, e, i, n) {
            ...
            for (const o of Object.keys(s))
                if (o.includes(n)) {
                    const n = s[o];
                    P(t, e, i, n.callable, n.delegationSelector)
                }
        }
        ...
        const N = {
            ...
            off(t, e, i, n) {
                if ("string" != typeof e || !t) return;
                const [s, o, r] = E(e, i, n), a = r !== e, l = S(t), h = l[r] || {}, c = e.startsWith(".");
                if (void 0 === o) {
                    if (c)
            ...
            trigger(t, e, i) {
                ...
                return l = L(l, i), a && l.preventDefault(), r && t.dispatchEvent(l), l.defaultPrevented && s && s.preventDefault(), l
            }
        };
        ...
        const j = {
            ...
            getDataAttribute: (t, e) => R(t.getAttribute(`data-bs-${z(e)}`))
        };
        class F {
            static get Default() {
                return {}
            ...
            _mergeConfigObj(t, e) {
                const i = o(e) ? j.getDataAttribute(e, "config") : {};
                return {
                    ...this.constructor.Default,
                    ..."object" == typeof i ? i : {},
                    ...o(e) ? j.getDataAttributes(e) : {},
                    ..."object" == typeof t ? t : {}
                }
            }
        ...
        class q extends F {
            constructor(t, e) {
                super(), (t = r(t)) && (this._element = t, this._config = this._getConfig(e), W.set(this._element, this.constructor.DATA_KEY, this))
            }
            dispose() {
                W.remove(this._element, this.constructor.DATA_KEY), N.off(this._element, this.constructor.EVENT_KEY);
        ...
        class G extends F {
            ...
            _initEvents() {
                this._supportPointerEvents ? (N.on(this._element, "pointerdown.bs.swipe", (t => this._start(t))), N.on(this._element, "pointerup.bs.swipe", (t => this._end(t))), this._element.classList.add("pointer-event")) : (N.on(this._element, "touchstart.bs.swipe", (t => this._start(t))), N.on(this._element, "touchmove.bs.swipe", (t => this._move(t))), N.on(this._element, "touchend.bs.swipe", (t => this._end(t))))
            }
        ...
        class at extends q {
            constructor(t, e) {
                super(t, e), this._interval = null, this._activeElement = null, this._isSliding = !1, this.touchTimeout = null, this._swipeHelper = null, this._indicatorsElement = U.findOne(".carousel-indicators", this._element), this._addEventListeners(), this._config.ride === it && this.cycle()
            }
            static get Default() {
                return ot
            }
            ...
            _maybeEnableCycle() {
                this._config.ride && (this._isSliding ? N.one(this._element, et, (() => this.cycle())) : this.cycle())
            }
            to(t) {
                const e = this._getItems();
                if (t > e.length - 1 || t < 0) return;
                if (this._isSliding) return void N.one(this._element, et, (() => this.to(t)));
            ...
            _addEventListeners() {
                this._config.keyboard && N.on(this._element, "keydown.bs.carousel", (t => this._keydown(t))), "hover" === this._config.pause && (N.on(this._element, "mouseenter.bs.carousel", (() => this.pause())), N.on(this._element, "mouseleave.bs.carousel", (() => this._maybeEnableCycle()))), this._config.touch && G.isSupported() && this._addTouchEventListeners()
            }
            _addTouchEventListeners() {
                for (const t of U.find(".carousel-item img", this._element)) N.on(t, "dragstart.bs.carousel", (t => t.preventDefault()));
                const t = {
            ...
            _slide(t, e = null) {
                ...
                s.classList.add(h), u(s), i.classList.add(l), s.classList.add(l), this._queueCallback((() => {
                    s.classList.remove(l, h), s.classList.add(nt), i.classList.remove(nt, h, l), this._isSliding = !1, r(et)
            ...
            _directionToOrder(t) {
                return f() ? t === Z ? J : Q : t === Z ? Q : J
            }
            _orderToDirection(t) {
                return f() ? t === J ? Z : tt : t === J ? tt : Z
            }
            static jQueryInterface(t) {
                return this.each((function() {
        ...
        N.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", (function(t) {
            ...
            return s ? (i.to(s), void i._maybeEnableCycle()) : "next" === j.getDataAttribute(this, "slide") ? (i.next(), void i._maybeEnableCycle()) : (i.prev(), void i._maybeEnableCycle())
        ...
        class ft extends q {
            ...
            show() {
                ...
                this._queueCallback((() => {
                    this._isTransitioning = !1, this._element.classList.remove(ct), this._element.classList.add(ht, lt), this._element.style[e] = "", N.trigger(this._element, "shown.bs.collapse")
            ...
            hide() {
                ...
                this._element.style[t] = `${this._element.getBoundingClientRect()[t]}px`, u(this._element), this._element.classList.add(ct), this._element.classList.remove(ht, lt);
                for (const t of this._triggerArray) {
                    const e = n(t);
                    e && !this._isShown(e) && this._addAriaAndCollapsedClass([t], !1)
                }
                this._isTransitioning = !0, this._element.style[t] = "", this._queueCallback((() => {
                    this._isTransitioning = !1, this._element.classList.remove(ct), this._element.classList.add(ht), N.trigger(this._element, "hidden.bs.collapse")
                }), this._element, !0)
            }
        ...
        N.on(document, "click.bs.collapse.data-api", ut, (function(t) {
        ...
        var gt = "top",
            ...
            At = [].concat(yt, [bt]).reduce((function(t, e) {
        ...
        function Yt(t) {
            return "undefined" != typeof ShadowRoot && (t instanceof jt(t).ShadowRoot || t instanceof ShadowRoot)
        }
        const Bt = {
            name: "applyStyles",
            enabled: !0,
            ...
            fn: function(t) {
                ...
                Object.keys(e.elements).forEach((function(t) {
                    var i = e.styles[t] || {},
                        n = e.attributes[t] || {},
                        s = e.elements[t];
                    qt(s) && zt(s) && (Object.assign(s.style, i), Object.keys(n).forEach((function(t) {
                        var e = n[t];
                ...
                return Object.assign(e.elements.popper.style, i.popper), e.styles = i, e.elements.arrow && Object.assign(e.elements.arrow.style, i.arrow),
                    function() {
                        Object.keys(e.elements).forEach((function(t) {
                            ...
                            qt(n) && zt(n) && (Object.assign(n.style, o), Object.keys(s).forEach((function(t) {
                                n.removeAttribute(t)
                            })))
                        }))
                    }
        ...
        function Vt(t, e) {
            ...
            if (qt(t) && e) {
                var o = t.offsetHeight,
                    r = t.offsetWidth;
                r > 0 && (n = Kt(i.width) / r || 1), o > 0 && (s = Kt(i.height) / o || 1)
            }
            return {
                width: i.width / n,
                height: i.height / s,
        ...
        function ee(t) {
            return "html" === zt(t) ? t : t.assignedSlot || t.parentNode || (Yt(t) ? t.host : null) || te(t)
        }

        function ie(t) {
            return qt(t) && "fixed" !== Jt(t).position ? t.offsetParent : null
        }

        function ne(t) {
            for (var e = jt(t), i = ie(t); i && Zt(i) && "static" === Jt(i).position;) i = ie(i);
            return i && ("html" === zt(i) || "body" === zt(i) && "static" === Jt(i).position) ? e : i || function(t) {
                var e = -1 !== navigator.userAgent.toLowerCase().indexOf("firefox");
                if (-1 !== navigator.userAgent.indexOf("Trident") && qt(t) && "fixed" === Jt(t).position) return null;
                var i = ee(t);
                for (Yt(i) && (i = i.host); qt(i) && ["html", "body"].indexOf(zt(i)) < 0;) {
                    var n = Jt(i);
        ...
        const le = {
            ...
            effect: function(t) {
                ...
                null != n && ("string" != typeof n || (n = e.elements.popper.querySelector(n))) && Qt(e.elements.popper, n) && (e.elements.arrow = n)
            },
        ...
        function ue(t) {
            ...
            if (h) {
                var x = ne(i),
                    C = "clientHeight",
                    k = "clientWidth";
                x === jt(i) && "static" !== Jt(x = te(i)).position && "absolute" === a && (C = "scrollHeight", k = "scrollWidth"), (s === gt || (s === _t || s === vt) && o === xt) && (y = mt, g -= (u && x === w && w.visualViewport ? w.visualViewport.height : x[C]) - n.height, g *= l ? 1 : -1), s !== _t && (s !== gt && s !== mt || o !== xt) || (b = vt, p -= (u && x === w && w.visualViewport ? w.visualViewport.width : x[k]) - n.width, p *= l ? 1 : -1)
            }
            ...
            return p = S.x, g = S.y, l ? Object.assign({}, D, ((T = {})[y] = _ ? "0" : "", T[b] = v ? "0" : "", T.transform = (w.devicePixelRatio || 1) <= 1 ? "translate(" + p + "px, " + g + "px)" : "translate3d(" + p + "px, " + g + "px, 0)", T)) : Object.assign({}, D, ((e = {})[y] = _ ? g + "px" : "", e[b] = v ? p + "px" : "", e.transform = "", e))
        }
        const de = {
            name: "computeStyles",
            enabled: !0,
        ...
        function ye(t) {
            return Vt(te(t)).left + be(t).scrollLeft
        }
        ...
        function xe(t) {
            return ["html", "body", "#document"].indexOf(zt(t)) >= 0 ? t.ownerDocument.body : qt(t) && we(t) ? t : xe(ee(t))
        }
        ...
        function Te(t, e) {
            return e === kt ? ke(function(t) {
                ...
                var e, i = te(t),
                    ...
                    o = $t(i.scrollWidth, i.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0),
                    r = $t(i.scrollHeight, i.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0),
                    a = -n.scrollLeft + ye(t),
                    l = -n.scrollTop;
                return "rtl" === Jt(s || i).direction && (a += $t(i.clientWidth, s ? s.clientWidth : 0) - o), {
                    width: o,
                    height: r,
                    x: a,
                    y: l
            ...
            var i = e,
                ...
                b = function(t, e, i) {
                    var n = "clippingParents" === e ? function(t) {
                            var e = Ce(ee(t)),
                                i = ["absolute", "fixed"].indexOf(Jt(t).position) >= 0 && qt(t) ? ne(t) : t;
                            return Ft(i) ? e.filter((function(t) {
                                return Ft(t) && Qt(t, i) && "body" !== zt(t)
                            })) : []
                        }(t) : [].concat(e),
                        s = [].concat(n, [i]),
                        o = s[0],
                        r = s.reduce((function(e, i) {
                            var n = Te(t, i);
                            return e.top = $t(n.top, e.top), e.right = Ut(n.right, e.right), e.bottom = Ut(n.bottom, e.bottom), e.left = $t(n.left, e.left), e
                        }), Te(t, o));
                    return r.width = r.right - r.left, r.height = r.bottom - r.top, r.x = r.left, r.y = r.top, r
                }(Ft(_) ? _ : _.contextElement || te(t.elements.popper), r, l),
        ...
        const Ae = {
            ...
            fn: function(t) {
                ...
                if (!e.modifiersData[n]._skip) {
                    for (var s = i.mainAxis, o = void 0 === s || s, r = i.altAxis, a = void 0 === r || r, l = i.fallbackPlacements, h = i.padding, c = i.boundary, u = i.rootBoundary, d = i.altBoundary, p = i.flipVariations, f = void 0 === p || p, g = i.allowedAutoPlacements, m = e.options.placement, v = Xt(m), _ = l || (v !== m && f ? function(t) {
                            if (Xt(t) === bt) return [];
                            var e = me(t);
                            return [_e(t), e, _e(e)]
                        }(m) : [me(m)]), b = [m].concat(_).reduce((function(t, i) {
                            return t.concat(Xt(i) === bt ? function(t, e) {
                                void 0 === e && (e = {});
                                var i = e,
                                    n = i.placement,
                                    s = i.boundary,
                        ...
                        }), []), y = e.rects.reference, w = e.rects.popper, x = new Map, C = !0, k = b[0], T = 0; T < b.length; T++) {
                        var D = b[T],
                            S = Xt(D),
                            A = he(D) === wt,
                            E = [gt, mt].indexOf(S) >= 0,
                        ...
                        var O = me(M),
                            N = [];
                        if (o && N.push(P[S] <= 0), a && N.push(P[M] <= 0, P[O] <= 0), N.every((function(t) {
                                return t
                            }))) {
                            k = D, C = !1;
                            break
                        ...
                        r = At.reduce((function(t, i) {
                            return t[i] = function(t, e, i) {
                                var n = Xt(t),
                                    ...
                                    r = o[0],
                                    a = o[1];
                                return r = r || 0, a = (a || 0) * s, [_t, vt].indexOf(n) >= 0 ? {
                                    x: a,
                                    y: r
                                } : {
                                    x: r,
                    ...
                    if (x) {
                        if (o) {
                            var E, I = "y" === y ? gt : _t,
                                ...
                                Y = F[P],
                                B = oe(0, C[M], j[M]),
                                X = b ? C[M] / 2 - H - B - q - D.mainAxis : W - B - q - D.mainAxis,
                                $ = b ? -C[M] / 2 + H + B + Y + D.mainAxis : R + B + Y + D.mainAxis,
                                U = e.elements.arrow && ne(e.elements.arrow),
                                K = U ? "y" === y ? U.clientTop || 0 : U.clientLeft || 0 : 0,
                                V = null != (E = null == S ? void 0 : S[y]) ? E : 0,
                                G = O + $ - V,
                                Q = oe(p ? Ut(N, O + X - V - K) : N, O, p ? $t(L, G) : L);
                            x[y] = Q, A[y] = Q - O
                        }
                        if (a) {
                            var J, Z = "x" === y ? gt : _t,
                                ...
                                nt = et + m[Z],
                                st = et - m[tt],
                                ot = -1 !== [gt, _t].indexOf(v),
                                rt = null != (J = null == S ? void 0 : S[w]) ? J : 0,
                                at = ot ? nt : et - C[it] - k[it] - rt + D.altAxis,
                                lt = ot ? et + C[it] + k[it] - rt - D.altAxis : st,
                                ht = p && ot ? function(t, e, i) {
                                    var n = oe(t, e, i);
                                    return n > i ? i : n
                                }(at, et, lt) : oe(p ? at : nt, et, p ? lt : st);
                            x[w] = ht, A[w] = ht - et
                        }
                        e.modifiersData[n] = A
                    }
        ...
        function Le(t, e, i) {
            ...
            var n, s, o = qt(e),
                r = qt(e) && function(t) {
                    var e = t.getBoundingClientRect(),
                        ...
                        n = Kt(e.height) / t.offsetHeight || 1;
                    return 1 !== i || 1 !== n
                }(e),
                a = te(e),
                l = Vt(t, r),
            ...
            return (o || !o && !i) && (("body" !== zt(e) || we(a)) && (h = (n = e) !== jt(n) && qt(n) ? {
                scrollLeft: (s = n).scrollLeft,
                scrollTop: s.scrollTop
            } : be(n)), qt(e) ? ((c = Vt(e, !0)).x += e.clientLeft, c.y += e.clientTop) : a && (c.x = ye(a))), {
                ...
                var s, r, a = {
                    ...
                    c = {
                        ...
                        setOptions: function(i) {
                            ...
                            }((r = [].concat(n, a.options.modifiers), h = r.reduce((function(t, e) {
                                var i = t[e.name];
                        ...
                        forceUpdate: function() {
                            if (!h) {
                                ...
                                if (Re(e, i)) {
                                    a.rects = {
                                        reference: Le(e, ne(i), "fixed" === a.options.strategy),
                                        popper: Gt(i)
        ...
        var je = ze(),
            Fe = ze({
                defaultModifiers: [fe, Oe, de, Bt]
            }),
            qe = ze({
                defaultModifiers: [fe, Oe, de, Bt, Me, Ae, Ne, le, Pe]
            });
        const Ye = Object.freeze(Object.defineProperty({
            ...
            Qe = `${Ge}.show`,
            Je = ".dropdown-menu",
            Ze = f() ? "top-end" : "top-start",
            ti = f() ? "top-start" : "top-end",
            ei = f() ? "bottom-end" : "bottom-start",
            ii = f() ? "bottom-start" : "bottom-end",
            ni = f() ? "left-start" : "right-start",
        ...
        class ai extends q {
            constructor(t, e) {
                super(t, e), this._popper = null, this._parent = this._element.parentNode, this._menu = U.findOne(Je, this._parent), this._inNavbar = this._detectNavbar()
            }
            static get Default() {
                return oi
            }
            ...
            show() {
                ...
                if (!N.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
                    if (this._createPopper(), "ontouchstart" in document.documentElement && !this._parent.closest(".navbar-nav"))
                        for (const t of [].concat(...document.body.children)) N.on(t, "mouseover", c);
                    this._element.focus(), this._element.setAttribute("aria-expanded", !0), this._menu.classList.add(Ve), this._element.classList.add(Ve), N.trigger(this._element, "shown.bs.dropdown", t)
                }
            }
            hide() {
                if (l(this._element) || !this._isShown()) return;
            ...
            _completeHide(t) {
                if (!N.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented) {
                    if ("ontouchstart" in document.documentElement)
                        for (const t of [].concat(...document.body.children)) N.off(t, "mouseover", c);
                    this._popper && this._popper.destroy(), this._menu.classList.remove(Ve), this._element.classList.remove(Ve), this._element.setAttribute("aria-expanded", "false"), j.removeDataAttribute(this._menu, "popper"), N.trigger(this._element, "hidden.bs.dropdown", t)
                }
            }
            _getConfig(t) {
                if ("object" == typeof(t = super._getConfig(t)).reference && !o(t.reference) && "function" != typeof t.reference.getBoundingClientRect) throw new TypeError(`${Be.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`);
                return t
            }
            _createPopper() {
            ...
            _getPopperConfig() {
                ...
                return (this._inNavbar || "static" === this._config.display) && (j.setDataAttribute(this._menu, "popper", "static"), t.modifiers = [{
                    name: "applyStyles",
                    enabled: !1
                }]), {
                    ...t,
            ...
            _selectMenuItem({
                ...
                i.length && _(i, e, t === $e, !i.includes(e)).focus()
            }
            static jQueryInterface(t) {
                return this.each((function() {
            ...
            static dataApiKeydownHandler(t) {
                const e = /input|textarea/i.test(t.target.tagName),
                    i = "Escape" === t.key,
                    n = [Xe, $e].includes(t.key);
                if (!n && !i) return;
                if (e && !i) return;
                t.preventDefault();
                const s = U.findOne(Ge, t.delegateTarget.parentNode),
                    o = ai.getOrCreateInstance(s);
                if (n) return t.stopPropagation(), o.show(), void o._selectMenuItem(t);
                o._isShown() && (t.stopPropagation(), o.hide(), s.focus())
            }
        }
        N.on(document, Ke, Ge, ai.dataApiKeydownHandler), N.on(document, Ke, Je, ai.dataApiKeydownHandler), N.on(document, Ue, ai.clearMenus), N.on(document, "keyup.bs.dropdown.data-api", ai.clearMenus), N.on(document, Ue, Ge, (function(t) {
        ...
        class di {
            ...
            hide() {
                ...
                this._disableOverFlow(), this._setElementAttributes(this._element, ci, (e => e + t)), this._setElementAttributes(li, ci, (e => e + t)), this._setElementAttributes(hi, ui, (e => e - t))
            }
            reset() {
                this._resetElementAttributes(this._element, "overflow"), this._resetElementAttributes(this._element, ci), this._resetElementAttributes(li, ci), this._resetElementAttributes(hi, ui)
            }
            isOverflowing() {
            ...
            _resetElementAttributes(t, e) {
                this._applyManipulationCallback(t, (t => {
                    ...
                    null !== i ? (j.removeDataAttribute(t, e), t.style.setProperty(e, i)) : t.style.removeProperty(e)
                }))
            }
        ...
        class vi extends F {
            ...
            show(t) {
                ...
                this._config.isAnimated && u(e), e.classList.add(pi), this._emulateAnimation((() => {
                    m(t)
                }))
            }
            hide(t) {
            ...
            dispose() {
                this._isAppended && (N.off(this._element, fi), this._element.remove(), this._isAppended = !1)
            }
            _getElement() {
                if (!this._element) {
            ...
            _append() {
                ...
                this._config.rootElement.append(t), N.on(t, fi, (() => {
        ...
        class xi extends F {
            ...
            activate() {
                this._isActive || (this._config.autofocus && this._config.trapElement.focus(), N.off(document, _i), N.on(document, "focusin.bs.focustrap", (t => this._handleFocusin(t))), N.on(document, "keydown.tab.bs.focustrap", (t => this._handleKeydown(t))), this._isActive = !0)
            }
            deactivate() {
                this._isActive && (this._isActive = !1, N.off(document, _i))
            }
            _handleFocusin(t) {
                const {
                    trapElement: e
                ...
                0 === i.length ? e.focus() : this._lastTabNavDirection === bi ? i[i.length - 1].focus() : i[0].focus()
            }
            _handleKeydown(t) {
                "Tab" === t.key && (this._lastTabNavDirection = t.shiftKey ? bi : "forward")
            }
        }
        ...
        class Ii extends q {
            constructor(t, e) {
                super(t, e), this._dialog = U.findOne(".modal-dialog", this._element), this._backdrop = this._initializeBackDrop(), this._focustrap = this._initializeFocusTrap(), this._isShown = !1, this._isTransitioning = !1, this._scrollBar = new di, this._addEventListeners()
            }
            static get Default() {
                return Ai
            }
            ...
            show(t) {
                this._isShown || this._isTransitioning || N.trigger(this._element, ki, {
                    relatedTarget: t
            ...
            hide() {
                this._isShown && !this._isTransitioning && (N.trigger(this._element, "hide.bs.modal").defaultPrevented || (this._isShown = !1, this._isTransitioning = !0, this._focustrap.deactivate(), this._element.classList.remove(Di), this._queueCallback((() => this._hideModal()), this._element, this._isAnimated())))
            }
            dispose() {
                for (const t of [window, this._dialog]) N.off(t, ".bs.modal");
            ...
            _showElement(t) {
                ...
                e && (e.scrollTop = 0), u(this._element), this._element.classList.add(Di), this._queueCallback((() => {
            ...
            _hideModal() {
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._isTransitioning = !1, this._backdrop.hide((() => {
                    document.body.classList.remove(Ti), this._resetAdjustments(), this._scrollBar.reset(), N.trigger(this._element, Ci)
                }))
            }
            _isAnimated() {
        ...
        N.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', (function(t) {
            const e = n(this);
            ["A", "AREA"].includes(this.tagName) && t.preventDefault(), N.one(e, ki, (t => {
                t.defaultPrevented || N.one(e, Ci, (() => {
                    a(this) && this.focus()
                }))
            }));
        ...
        class zi extends q {
            ...
            show(t) {
                this._isShown || N.trigger(this._element, "show.bs.offcanvas", {
                    relatedTarget: t
                }).defaultPrevented || (this._isShown = !0, this._backdrop.show(), this._config.scroll || (new di).hide(), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), this._element.classList.add(Mi), this._queueCallback((() => {
                    this._config.scroll && !this._config.backdrop || this._focustrap.activate(), this._element.classList.add(Pi), this._element.classList.remove(Mi), N.trigger(this._element, "shown.bs.offcanvas", {
                        relatedTarget: t
                    })
                }), this._element, !0))
            }
            hide() {
                this._isShown && (N.trigger(this._element, "hide.bs.offcanvas").defaultPrevented || (this._focustrap.deactivate(), this._element.blur(), this._isShown = !1, this._element.classList.add(Oi), this._backdrop.hide(), this._queueCallback((() => {
                    this._element.classList.remove(Pi, Oi), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._config.scroll || (new di).reset(), N.trigger(this._element, Hi)
                }), this._element, !0)))
            }
            dispose() {
                this._backdrop.dispose(), this._focustrap.deactivate(), super.dispose()
            ...
            _initializeBackDrop() {
                ...
                return new vi({
                    ...
                    clickCallback: t ? () => {
                        "static" !== this._config.backdrop ? this.hide() : N.trigger(this._element, Li)
                    } : null
                })
            }
            _initializeFocusTrap() {
            ...
            _addEventListeners() {
                N.on(this._element, "keydown.dismiss.bs.offcanvas", (t => {
                    "Escape" === t.key && (this._config.keyboard ? this.hide() : N.trigger(this._element, Li))
                }))
            }
            static jQueryInterface(t) {
                return this.each((function() {
        ...
        N.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', (function(t) {
            ...
            const i = U.findOne(Ni);
            i && i !== e && zi.getInstance(i).hide(), zi.getOrCreateInstance(e).toggle(this)
        })), N.on(window, "load.bs.offcanvas.data-api", (() => {
            for (const t of U.find(Ni)) zi.getOrCreateInstance(t).show()
        })), N.on(window, "resize.bs.offcanvas", (() => {
            for (const t of U.find("[aria-modal][class*=show][class*=offcanvas-]")) "fixed" !== getComputedStyle(t).position && zi.getOrCreateInstance(t).hide()
        })), Y(zi), g(zi);
        const ji = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]),
            ...
            Yi = (t, e) => {
                ...
                return e.includes(i) ? !ji.has(i) || Boolean(Fi.test(t.nodeValue) || qi.test(t.nodeValue)) : e.filter((t => t instanceof RegExp)).some((t => t.test(i)))
            },
            Bi = {
                ...
                return this._config.sanitize ? function(t, e, i) {
                    ...
                    for (const t of s) {
                        ...
                        const n = [].concat(...t.attributes),
                            s = [].concat(e["*"] || [], e[i] || []);
                        for (const e of n) Yi(e, s) || t.removeAttribute(e.nodeName)
                    }
        ...
        class rn extends q {
            ...
            dispose() {
                clearTimeout(this._timeout), N.off(this._element.closest(Ji), Zi, this._hideModalHandler), this.tip && this.tip.remove(), this._disposePopper(), super.dispose()
            }
            show() {
                ...
                if (this._element.ownerDocument.documentElement.contains(this.tip) || (n.append(i), N.trigger(this._element, this.constructor.eventName("inserted"))), this._popper ? this._popper.update() : this._popper = this._createPopper(i), i.classList.add(Qi), "ontouchstart" in document.documentElement)
                    for (const t of [].concat(...document.body.children)) N.on(t, "mouseover", c);
                this._queueCallback((() => {
            ...
            _createTipElement(t) {
                ...
                if (!e) return null;
                e.classList.remove(Gi, Qi), e.classList.add(`bs-${this.constructor.NAME}-auto`);
                const i = (t => {
                    do {
            ...
            _setListeners() {
                ...
                }, N.on(this._element.closest(Ji), Zi, this._hideModalHandler), this._config.selector ? this._config = {
                    ...this._config,
                    trigger: "manual",
                    selector: ""
                } : this._fixTitle()
        ...
        class gn extends q {
            ...
            _maybeEnableSmoothScroll() {
                this._config.smoothScroll && (N.off(this._config.target, cn), N.on(this._config.target, cn, dn, (t => {
            ...
            _initializeTargetsAndObservables() {
                ...
                const t = U.find(dn, this._config.target);
                for (const e of t) {
            ...
            _process(t) {
                this._activeTarget !== t && (this._clearActiveClass(this._config.target), this._activeTarget = t, t.classList.add(un), this._activateParents(t), N.trigger(this._element, "activate.bs.scrollspy", {
                    relatedTarget: t
                }))
            }
            _activateParents(t) {
                if (t.classList.contains("dropdown-item")) U.findOne(".dropdown-toggle", t.closest(".dropdown")).classList.add(un);
                else
                    for (const e of U.parents(t, ".nav, .list-group"))
                        for (const t of U.prev(e, ".nav-link, .nav-item > .nav-link, .list-group-item")) t.classList.add(un)
            }
            _clearActiveClass(t) {
        ...
        N.on(window, "load.bs.scrollspy.data-api", (() => {
            for (const t of U.find('[data-bs-spy="scroll"]')) gn.getOrCreateInstance(t)
        })), g(gn);
        const mn = "ArrowLeft",
            vn = "ArrowRight",
            _n = "ArrowUp",
            ...
            kn = `.nav-link:not(.dropdown-toggle), .list-group-item:not(.dropdown-toggle), [role="tab"]:not(.dropdown-toggle), ${Cn}`;
        class Tn extends q {
            constructor(t) {
                super(t), this._parent = this._element.closest('.list-group, .nav, [role="tablist"]'), this._parent && (this._setInitialAttributes(this._parent, this._getChildren()), N.on(this._element, "keydown.bs.tab", (t => this._keydown(t))))
            }
            static get NAME() {
                return "tab"
            }
            show() {
                ...
                const e = this._getActiveElem(),
                    i = e ? N.trigger(e, "hide.bs.tab", {
                        relatedTarget: t
                    }) : null;
                N.trigger(t, "show.bs.tab", {
                    relatedTarget: e
                }).defaultPrevented || i && i.defaultPrevented || (this._deactivate(e, t), this._activate(t, e))
            }
            _activate(t, e) {
                t && (t.classList.add(yn), this._activate(n(t)), this._queueCallback((() => {
                    "tab" === t.getAttribute("role") ? (t.focus(), t.removeAttribute("tabindex"), t.setAttribute("aria-selected", !0), this._toggleDropDown(t, !0), N.trigger(t, "shown.bs.tab", {
                        relatedTarget: e
                    })) : t.classList.add(xn)
                }), t, t.classList.contains(wn)))
            }
            _deactivate(t, e) {
                t && (t.classList.remove(yn), t.blur(), this._deactivate(n(t)), this._queueCallback((() => {
                    "tab" === t.getAttribute("role") ? (t.setAttribute("aria-selected", !1), t.setAttribute("tabindex", "-1"), this._toggleDropDown(t, !1), N.trigger(t, "hidden.bs.tab", {
                        relatedTarget: e
                    })) : t.classList.remove(xn)
                }), t, t.classList.contains(wn)))
            }
            _keydown(t) {
                if (![mn, vn, _n, bn].includes(t.key)) return;
                t.stopPropagation(), t.preventDefault();
                const e = [vn, bn].includes(t.key),
                    i = _(this._getChildren().filter((t => !l(t))), t.target, e, !0);
                i && Tn.getOrCreateInstance(i).show()
            }
            _getChildren() {
                return U.find(kn, this._parent)
            }
            _getActiveElem() {
            ...
            _toggleDropDown(t, e) {
                ...
                n(".dropdown-toggle", yn), n(".dropdown-menu", xn), n(".dropdown-item", yn), i.setAttribute("aria-expanded", e)
            }
            ...
            _getInnerElement(t) {
                return t.matches(kn) ? t : U.findOne(kn, t)
            }
            _getOuterElement(t) {
        ...
        N.on(document, "click.bs.tab", Cn, (function(t) {
            ["A", "AREA"].includes(this.tagName) && t.preventDefault(), l(this) || Tn.getOrCreateInstance(this).show()
        })), N.on(window, "load.bs.tab", (() => {
            for (const t of U.find('.active[data-bs-toggle="tab"], .active[data-bs-toggle="pill"], .active[data-bs-toggle="list"]')) Tn.getOrCreateInstance(t)
        })), g(Tn);
        const Dn = "hide",
            Sn = "show",
            An = "showing",
        ...
        class Pn extends q {
            ...
            show() {
                N.trigger(this._element, "show.bs.toast").defaultPrevented || (this._clearTimeout(), this._config.animation && this._element.classList.add("fade"), this._element.classList.remove(Dn), u(this._element), this._element.classList.add(Sn, An), this._queueCallback((() => {
                    this._element.classList.remove(An), N.trigger(this._element, "shown.bs.toast"), this._maybeScheduleHide()
                }), this._element, this._config.animation))
            }
            hide() {
                this.isShown() && (N.trigger(this._element, "hide.bs.toast").defaultPrevented || (this._element.classList.add(An), this._queueCallback((() => {
                    this._element.classList.add(Dn), this._element.classList.remove(An, Sn), N.trigger(this._element, "hidden.bs.toast")
                }), this._element, this._config.animation)))
            }
            dispose() {
    ...
    function(t, e) {
        ...
        var T = {
                ...
                wheel: function(n) {
                    ...
                    function o(i) {
                        ...
                        if (!s(i.target, a, l)) {
                            ...
                            }(a, l), h && !i.ctrlKey && (i.stopPropagation(), i.preventDefault())
                        }
                    }
                    var r = n.element;
                ...
                touch: function(n) {
                    ...
                    function u() {
                        n.settings.swipeEasing && (clearInterval(v), v = setInterval((function() {
                            return n.isInitialized ? void clearInterval(v) : m.x || m.y ? .01 > t(m.x) && .01 > t(m.y) ? void clearInterval(v) : n.element ? (o(30 * m.x, 30 * m.y), m.x *= .8, void(m.y *= .8)) : void clearInterval(v) : void clearInterval(v)
                        }), 10))
                    }
            ...
            S = function(t, o) {
                ...
                }(), this.negativeScrollAdjustment = this.isNegativeScroll ? t.scrollWidth - t.clientWidth : 0, this.event = new k, this.ownerDocument = t.ownerDocument || document, this.scrollbarXRail = s(y.element.rail("x")), t.appendChild(this.scrollbarXRail), this.scrollbarX = s(y.element.thumb("x")), this.scrollbarXRail.appendChild(this.scrollbarX), this.scrollbarX.setAttribute("tabindex", 0), this.event.bind(this.scrollbarX, "focus", l), this.event.bind(this.scrollbarX, "blur", h), this.scrollbarXActive = null, this.scrollbarXWidth = null, this.scrollbarXLeft = null;
